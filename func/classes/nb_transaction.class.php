...
<b>Payment Status:</b> $tPayStat <br />
		...
		switch($emlWhy){
			case 'new_student':
				...
				$emlMsg = "
<p>Thank you for registering with New Beginnings Doula 
...
/******///Need to check $emlWho; 
		...
		$nbEmailConfirm->recipient = (strcmp( $emlWhy, 'admin') == 0)? 2 :$this->tPost['student_id']; //Make sure this is being sent to admin if is ADMIN. 
