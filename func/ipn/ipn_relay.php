...
Line 140: update email credentials for your specific environment. 
Line 244: email address to ignore when receiving payments from these. 
*********/
//echo "working?";
...
function sort_ipn( array $ipn_data ){
		...
		$biz_email = ( $ipn_data[ 'ipn_sandbox' ] )? "/* Test PayPal Account Email Addrees Goes here */" : "/* Live PayPal Account Email Address Goes here. */" ; //True= sandbox, False = live. 
...
function is_admin_payment( array $ipn_data ){
	...
	$admin_arr = array(
		...
		'/* Additional Email Address to Ignore */'
	);
