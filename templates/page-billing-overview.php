 ...
 */
	...
	if( !$nb_alumnus ) { //If not alumni, is student
		...
		echo "<p>Registration Date: <em>$nb_stud_reg_date</em></p><p>Our billing systems are in transition. Some functionality is still available. For additional in questions regarding your account, please contact Brent directly at brent@trainingdoulas.com. Thank you!</p>";
